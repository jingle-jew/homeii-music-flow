...
export function getBaseCardConfigForm() {
  ...
  const helpers = {
    ...
    homeii_engine_mode: "Optional HOMEii Flow Engine bridge. Auto keeps today's card behavior and uses the integration only when it is installed. Off disables Engine calls. Required is useful for testing and diagnostics.",
        ...
        schema: [
          {
            ...
            schema: [
              ...
              { name: "homeii_engine_mode", selector: { select: { mode: "dropdown", options: [
                { value: "auto", label: "Auto" },
                { value: "off", label: "Off" },
                { value: "required", label: "Required" },
              ] } } },
              { name: "homeii_engine_instance_id", selector: { text: {} } },
              { name: "homeii_engine_profile_id", selector: { text: {} } },
              { name: "homeii_engine_timeout_ms", selector: { number: { min: 1000, max: 30000, step: 500, mode: "box" } } },
...
export function getMobileEditorTexts() {
  ...
  return {
    sections: {
      ...
      screensaver: homeiiEditorI18n("ui.screensaver", {}, "Screensaver"),
    },
    labels: {
      ...
      screensaver_auto_lyrics_when_playing: homeiiEditorI18n("ui.lyrics_while_playing", {}, "Lyrics while playing"),
    ...
    helpers: {
      ...
      screensaver_auto_lyrics_when_playing: homeiiEditorI18n("ui.screensaver_lyrics_while_playing_helper", {}, "When enabled, screensaver opens in lyrics mode while music is playing and stays in clock mode when idle."),
    ...
    options: {
      ...
      screensaver_control_buttons: [
        ...
        { value: "like", label: homeiiEditorI18n("ui.like_2") },
        { value: "lyrics", label: homeiiEditorI18n("ui.lyrics") },
        { value: "lyrics_sync", label: homeiiEditorI18n("ui.sync_lyrics") },
        { value: "lyrics_font_minus", label: homeiiEditorI18n("ui.smaller_lyrics") },
        { value: "lyrics_font_plus", label: homeiiEditorI18n("ui.larger_lyrics") },
        { value: "voice", label: homeiiEditorI18n("ui.flow_assistant", {}, "FLOW ASSISTANT") },
      ],
      power_button_action: [
        ...
        schema: [
          {
            ...
            schema: [
              { name: "card_id", selector: { text: {} } },
              { name: "homeii_engine_mode", selector: { select: { mode: "dropdown", options: t.options.homeii_engine_mode } } },
              { name: "homeii_engine_instance_id", selector: { text: {} } },
              { name: "homeii_engine_profile_id", selector: { text: {} } },
              { name: "homeii_engine_timeout_ms", selector: { number: { min: 1000, max: 30000, step: 500, mode: "box" } } },
              { name: "config_entry_id", selector: { text: {} } },
